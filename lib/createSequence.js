...
module.exports = function (through) {
    return function () {
        ...
        var first = streams.length ? streams[0] : through(function (chunk, enc, callback) { callback(null, chunk) });
        ...
        var output = streams.length ? streams.reduce(function (previous, current) {
